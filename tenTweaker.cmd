...
if "%programs_system_program_3DBuilder%" == "installed" (
  call %stringBuilder_build% %language_stringBuilder_option_installed%
) else if "%programs_system_program_3DBuilder%" == "uninstalled" (
...
if "%programs_system_program_mixedRealityPortal%" == "installed" (
  call %stringBuilder_build% %language_stringBuilder_option_installed%
) else if "%programs_system_program_mixedRealityPortal%" == "uninstalled" (
  call %stringBuilder_build% %language_stringBuilder_option_uninstalled%
) else call %stringBuilder_build% %language_stringBuilder_option_error%
...
set stringBuilder_string=%language_programs_system29%
if "%programs_system_program_tips%" == "installed" (
  call %stringBuilder_build% %language_stringBuilder_option_installed%
) else if "%programs_system_program_tips%" == "uninstalled" (
  call %stringBuilder_build% %language_stringBuilder_option_uninstalled%
) else call %stringBuilder_build% %language_stringBuilder_option_error%
call %stringBuilder_build%    %language_programs_system30%
...
set stringBuilder_string=%language_programs_system31%
if "%programs_system_program_yourPhone%" == "installed" (
  call %stringBuilder_build% %language_stringBuilder_option_installed%
) else if "%programs_system_program_yourPhone%" == "uninstalled" (
  call %stringBuilder_build% %language_stringBuilder_option_uninstalled%
) else call %stringBuilder_build% %language_stringBuilder_option_error%
call %stringBuilder_build%    %language_programs_system32%
...
if "%1" == "check"  for /f "eol=- delims=" %%i in ('find /i "Microsoft.%2" "%~dp0temp\return_appxPackages"') do if "%%i" NEQ "" set %3=installed
...
set language_programs_system03=^^(1^^) 3D Builder                        
set language_programs_system04=^^(G^^) Alarms and Clock                  
set language_programs_system05=^^(2^^) 3D Viewer                         
set language_programs_system06=^^(H^^) Camera                            
set language_programs_system07=^^(3^^) Feedback Hub                      
set language_programs_system08=^^(I^^) Game bar                          
set language_programs_system09=^^(4^^) Get Help                          
set language_programs_system10=^^(J^^) Groove Music                      
set language_programs_system11=^^(5^^) Mail and Calendar                 
set language_programs_system12=^^(K^^) Movies and TV                     
set language_programs_system13=^^(6^^) Maps                              
set language_programs_system14=^^(L^^) My Office                         
set language_programs_system15=^^(7^^) Messaging                         
set language_programs_system16=^^(M^^) Paint 3D                          
set language_programs_system17=^^(8^^) Mixed Reality Portal              
set language_programs_system18=^^(N^^) Photos                            
set language_programs_system19=^^(9^^) Mobile Plans                      
set language_programs_system20=^^(O^^) Skype                             
set language_programs_system21=^^(A^^) OneNote                           
set language_programs_system22=^^(P^^) Snip and Sketch                   
set language_programs_system23=^^(B^^) People                            
set language_programs_system24=^^(Q^^) Sticky Notes                      
set language_programs_system25=^^(C^^) Print 3D                          
set language_programs_system26=^^(R^^) Store                             
set language_programs_system27=^^(D^^) Solitare                          
set language_programs_system28=^^(S^^) Voice Recorder                    
set language_programs_system29=^^(E^^) Tips                              
set language_programs_system30=^^(T^^) Weather                           
set language_programs_system31=^^(F^^) Your Phone                        
set language_programs_system32=^^(U^^) Xbox                              
set language_programs_system33=^^(V^^) Install all
set language_programs_system34=^^(W^^) Uninstall all
...
set language_programs_system03=^^(1^^) 3D Builder                        
set language_programs_system04=^^(G^^) Будильники и Часы                 
set language_programs_system05=^^(2^^) 3D-модели                         
set language_programs_system06=^^(H^^) Камера                            
set language_programs_system07=^^(3^^) Обратная Связь                    
set language_programs_system08=^^(I^^) Игровая панель                    
set language_programs_system09=^^(4^^) Помощник                          
set language_programs_system10=^^(J^^) Музыка Groove                     
set language_programs_system11=^^(5^^) Почта и Календарь                 
set language_programs_system12=^^(K^^) Фильмы и Телевидение              
set language_programs_system13=^^(6^^) Карты                             
set language_programs_system14=^^(L^^) Office                            
set language_programs_system15=^^(7^^) Сообщения                         
set language_programs_system16=^^(M^^) Paint 3D                          
set language_programs_system17=^^(8^^) Портал смешанной реальности       
set language_programs_system18=^^(N^^) Фотографии                        
set language_programs_system19=^^(9^^) Мобильные тарифы                  
set language_programs_system20=^^(O^^) Skype                             
set language_programs_system21=^^(A^^) OneNote                           
set language_programs_system22=^^(P^^) Фрагмент и Набросок               
set language_programs_system23=^^(B^^) Люди                              
set language_programs_system24=^^(Q^^) Наклейки                          
set language_programs_system25=^^(C^^) Print 3D                          
set language_programs_system26=^^(R^^) Магазин                           
set language_programs_system27=^^(D^^) Solitare                          
set language_programs_system28=^^(S^^) Звукозаписыватель                 
set language_programs_system29=^^(E^^) Подсказки                         
set language_programs_system30=^^(T^^) Погода                            
set language_programs_system31=^^(F^^) Ваш Телефон                       
set language_programs_system32=^^(U^^) Xbox                              
set language_programs_system33=^^(V^^) Установить всё
set language_programs_system34=^^(W^^) Деинсталировать всё
...
set language_programs_system03=^^(1^^) 3D Builder                        
set language_programs_system04=^^(G^^) Будильники та Годинники           
set language_programs_system05=^^(2^^) 3D-моделі                         
set language_programs_system06=^^(H^^) Камера                            
set language_programs_system07=^^(3^^) Зворотній Зв'язок                 
set language_programs_system08=^^(I^^) Ігрова панель                     
set language_programs_system09=^^(4^^) Помічник                          
set language_programs_system10=^^(J^^) Музика Groove                     
set language_programs_system11=^^(5^^) Пошта і Календар                  
set language_programs_system12=^^(K^^) Фільми й Телепрограми             
set language_programs_system13=^^(6^^) Карти                             
set language_programs_system14=^^(L^^) Office                            
set language_programs_system15=^^(7^^) Повідомлення                      
set language_programs_system16=^^(M^^) Paint 3D                          
set language_programs_system17=^^(8^^) Портал змішаної реальності        
set language_programs_system18=^^(N^^) Фотографії                        
set language_programs_system19=^^(9^^) Мобільні тарифи                   
set language_programs_system20=^^(O^^) Skype                             
set language_programs_system21=^^(A^^) OneNote                           
set language_programs_system22=^^(P^^) Фрагмент і Ескіз                  
set language_programs_system23=^^(B^^) Люди                              
set language_programs_system24=^^(Q^^) Наліпки                           
set language_programs_system25=^^(C^^) Print 3D                          
set language_programs_system26=^^(R^^) Магазин                           
set language_programs_system27=^^(D^^) Solitare                          
set language_programs_system28=^^(S^^) Звукозаписувач                    
set language_programs_system29=^^(E^^) Підказки                          
set language_programs_system30=^^(T^^) Погода                            
set language_programs_system31=^^(F^^) Ваш Телефон                       
set language_programs_system32=^^(U^^) Xbox                              
set language_programs_system33=^^(V^^) Установити все
set language_programs_system34=^^(W^^) Деінсталювати все
