...
set language_programs_system15=^^(D^^) Alarms & Clock
set language_programs_system04=^^(2^^) Feedback Hub
set language_programs_system16=^^(E^^) Camera
set language_programs_system05=^^(3^^) Get Help
set language_programs_system17=^^(F^^) Groove Music
set language_programs_system06=^^(4^^) Mail and Calendar
set language_programs_system18=^^(G^^) Movies and TV
set language_programs_system07=^^(5^^) Maps
set language_programs_system19=^^(H^^) My Office
set language_programs_system08=^^(6^^) Messaging
set language_programs_system20=^^(I^^) Paint 3D
set language_programs_system09=^^(7^^) Mobile Plans
set language_programs_system21=^^(J^^) Skype
set language_programs_system10=^^(8^^) OneNote
set language_programs_system22=^^(K^^) Sticky Notes
set language_programs_system11=^^(9^^) People
set language_programs_system23=^^(L^^) Store
set language_programs_system12=^^(A^^) Print 3D
set language_programs_system24=^^(M^^) Voice Recorder
set language_programs_system13=^^(B^^) Solitare
set language_programs_system25=^^(N^^) Weather
set language_programs_system14=^^(C^^) Tips
