...
set sBuilder_text=^(1^) %lang_interface_desktop03%
       if "%interface_desktop_objects_thisPC%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_desktop_objects_thisPC%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                       %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(4^) %lang_interface_desktop04%
       if "%interface_desktop_objects_userFolder%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_desktop_objects_userFolder%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                           %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(2^) %lang_interface_desktop05%
       if "%interface_desktop_objects_recycleBin%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_desktop_objects_recycleBin%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                           %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(5^) %lang_interface_desktop06%
       if "%interface_desktop_objects_network%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_desktop_objects_network%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                        %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(3^) %lang_interface_desktop07%
       if "%interface_desktop_objects_controlPanel%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_desktop_objects_controlPanel%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                             %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
set sBuilder_text=^(6^) %lang_interface_desktop08%
       if "%interface_desktop_logonBackgroundBlur%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%interface_desktop_logonBackgroundBlur%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                              %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
set sBuilder_text=^(1^) %lang_interface_taskBar03%
       if "%interface_taskBar_peopleBand%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_taskBar_peopleBand%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                   %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(4^) %lang_interface_taskBar04%
       if "%interface_taskBar_smallIcons%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%interface_taskBar_smallIcons%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                     %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(2^) %lang_interface_taskBar05%
       if "%interface_taskBar_commandPromptOnWinX%" == "powerShell"    ( %sBuilder_build% %lang_sBuilder_option_powerShell%
) else if "%interface_taskBar_commandPromptOnWinX%" == "commandPrompt" ( %sBuilder_build% %lang_sBuilder_option_commandPrompt%
) else                                                                   %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(5^) %lang_interface_taskBar06%
       if "%interface_taskBar_buttonsCombine%" == "always"       ( %sBuilder_build% %lang_sBuilder_option_always%
) else if "%interface_taskBar_buttonsCombine%" == "when is full" ( %sBuilder_build% %lang_sBuilder_option_whenIsFull%
) else if "%interface_taskBar_buttonsCombine%" == "never"        ( %sBuilder_build% %lang_sBuilder_option_never%
) else                                                             %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(3^) %lang_interface_taskBar07%
       if "%interface_taskBar_taskViewButton%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_taskBar_taskViewButton%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                       %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
set sBuilder_text=^(1^) %lang_interface_explorer03%
       if "%interface_explorer_fileExtensions%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_fileExtensions%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                        %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(6^) %lang_interface_explorer04%
       if "%interface_explorer_ribbon%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_ribbon%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(2^) %lang_interface_explorer05%
       if "%interface_explorer_hiddenFiles%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_hiddenFiles%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                     %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(7^) %lang_interface_explorer06%
       if "%interface_explorer_expandToCurrentFolder%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%interface_explorer_expandToCurrentFolder%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                                 %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(3^) %lang_interface_explorer07%
       if "%interface_explorer_hiddenProtectedSystemFiles%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_hiddenProtectedSystemFiles%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                                    %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(8^) %lang_interface_explorer08%
       if "%interface_explorer_statusBar%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_statusBar%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                   %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(4^) %lang_interface_explorer09%
       if "%interface_explorer_emptyDrives%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_emptyDrives%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                     %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(9^) %lang_interface_explorer10%
       if "%interface_explorer_fileInfoTip%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_fileInfoTip%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                     %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(5^) %lang_interface_explorer11%
       if "%interface_explorer_folderMergeConflicts%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_folderMergeConflicts%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                              %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
set sBuilder_text=^(A^) %lang_interface_explorer13%
       if "%interface_explorer_thisPC_desktop%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_thisPC_desktop%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                        %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(E^) %lang_interface_explorer14%
       if "%interface_explorer_thisPC_pictures%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_thisPC_pictures%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                         %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(B^) %lang_interface_explorer15%
       if "%interface_explorer_thisPC_documents%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_thisPC_documents%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                          %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(F^) %lang_interface_explorer16%
       if "%interface_explorer_thisPC_videos%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_thisPC_videos%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                       %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(C^) %lang_interface_explorer17%
       if "%interface_explorer_thisPC_downloads%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_thisPC_downloads%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                          %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(G^) %lang_interface_explorer18%
       if "%interface_explorer_thisPC_3DObjects%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_thisPC_3DObjects%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                          %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(D^) %lang_interface_explorer19%
       if "%interface_explorer_thisPC_music%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_thisPC_music%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                      %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(H^) %lang_interface_explorer20%
       if "%interface_explorer_oneDriveInNavbar%" == "shown"  ( %sBuilder_build% %lang_sBuilder_option_shown%
) else if "%interface_explorer_oneDriveInNavbar%" == "hidden" ( %sBuilder_build% %lang_sBuilder_option_hidden%
) else                                                          %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
echo.

set sBuilder_text=^(I^) %lang_interface_explorer21%
       if "%interface_explorer_autoFolderTypeDiscovery%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%interface_explorer_autoFolderTypeDiscovery%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                                   %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
set sBuilder_text=^(1^) %lang_interface_input03%
       if "%interface_input_suggestions_auto%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%interface_input_suggestions_auto%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                         %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(2^) %lang_interface_input04%
       if "%interface_input_suggestions_appendCompletion%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%interface_input_suggestions_appendCompletion%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                                     %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(3^) %lang_interface_input05%
       if "%interface_input_suggestions_startTrackProgs%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%interface_input_suggestions_startTrackProgs%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                                    %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(4^) %lang_interface_input06%
       if "%interface_input_suggestions_whenTyping%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%interface_input_suggestions_whenTyping%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                               %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
set sBuilder_text=^(5^) %lang_interface_input08%
       if "%interface_input_keyboard_languageSwitch%" == "notAssigned"  ( %sBuilder_build% %lang_sBuilder_option_notAssigned%
) else if "%interface_input_keyboard_languageSwitch%" == "ctrlShift"    ( %sBuilder_build% %lang_sBuilder_option_ctrlShift%
) else if "%interface_input_keyboard_languageSwitch%" == "leftAltShift" ( %sBuilder_build% %lang_sBuilder_option_leftAltShift%
) else if "%interface_input_keyboard_languageSwitch%" == "graveAccent"  ( %sBuilder_build% %lang_sBuilder_option_graveAccent%
) else                                                                    %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(6^) %lang_interface_input09%
       if "%interface_input_keyboard_layoutSwitch%" == "notAssigned"  ( %sBuilder_build% %lang_sBuilder_option_notAssigned%
) else if "%interface_input_keyboard_layoutSwitch%" == "ctrlShift"    ( %sBuilder_build% %lang_sBuilder_option_ctrlShift%
) else if "%interface_input_keyboard_layoutSwitch%" == "leftAltShift" ( %sBuilder_build% %lang_sBuilder_option_leftAltShift%
) else if "%interface_input_keyboard_layoutSwitch%" == "graveAccent"  ( %sBuilder_build% %lang_sBuilder_option_graveAccent%
) else                                                                  %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
set sBuilder_text=^(1^) %lang_programs_system03%
       if "%programs_system_program_3DBuilder%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_3DBuilder%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                             %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(G^) %lang_programs_system04%
       if "%programs_system_program_alarmsClock%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_alarmsClock%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                               %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(2^) %lang_programs_system05%
       if "%programs_system_program_3DViewer%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_3DViewer%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                            %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(H^) %lang_programs_system06%
       if "%programs_system_program_camera%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_camera%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                          %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(3^) %lang_programs_system07%
       if "%programs_system_program_feedbackHub%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_feedbackHub%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                               %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(I^) %lang_programs_system08%
       if "%programs_system_program_gameBar%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_gameBar%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                           %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(4^) %lang_programs_system09%
       if "%programs_system_program_getHelp%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_getHelp%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                           %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(J^) %lang_programs_system10%
       if "%programs_system_program_grooveMusic%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_grooveMusic%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                               %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(5^) %lang_programs_system11%
       if "%programs_system_program_mailCalendar%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_mailCalendar%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                                %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(K^) %lang_programs_system12%
       if "%programs_system_program_moviesTV%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_moviesTV%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                            %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(6^) %lang_programs_system13%
       if "%programs_system_program_maps%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_maps%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                        %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(L^) %lang_programs_system14%
       if "%programs_system_program_myOffice%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_myOffice%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                            %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(7^) %lang_programs_system15%
       if "%programs_system_program_messaging%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_messaging%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                             %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(M^) %lang_programs_system16%
       if "%programs_system_program_paint3D%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_paint3D%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                           %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(8^) %lang_programs_system17%
       if "%programs_system_program_mixedRealityPortal%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_mixedRealityPortal%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                                      %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(N^) %lang_programs_system18%
       if "%programs_system_program_photos%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_photos%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                          %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(9^) %lang_programs_system19%
       if "%programs_system_program_mobilePlans%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_mobilePlans%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                               %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(O^) %lang_programs_system20%
       if "%programs_system_program_skype%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_skype%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                         %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(A^) %lang_programs_system21%
       if "%programs_system_program_oneNote%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_oneNote%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                           %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(P^) %lang_programs_system22%
       if "%programs_system_program_snipSketch%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_snipSketch%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                              %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(B^) %lang_programs_system23%
       if "%programs_system_program_people%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_people%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                          %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(Q^) %lang_programs_system24%
       if "%programs_system_program_stickyNotes%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_stickyNotes%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                               %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(C^) %lang_programs_system25%
       if "%programs_system_program_print3D%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_print3D%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                           %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(R^) %lang_programs_system26%
       if "%programs_system_program_store%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_store%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                         %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(D^) %lang_programs_system27%
       if "%programs_system_program_solitare%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_solitare%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                            %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(S^) %lang_programs_system28%
       if "%programs_system_program_voiceRecorder%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_voiceRecorder%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                                 %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(E^) %lang_programs_system29%
       if "%programs_system_program_tips%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_tips%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                        %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(T^) %lang_programs_system30%
       if "%programs_system_program_weather%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_weather%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                           %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(F^) %lang_programs_system31%
       if "%programs_system_program_yourPhone%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_yourPhone%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                             %sBuilder_build% %lang_sBuilder_option_error%
%sBuilder_build%    ^(U^) %lang_programs_system32%
       if "%programs_system_program_xbox%" == "installed"   ( %sBuilder_build% %lang_sBuilder_option_installed%
) else if "%programs_system_program_xbox%" == "uninstalled" ( %sBuilder_build% %lang_sBuilder_option_uninstalled%
) else                                                        %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
if "%error_main_variables_disabledRegistryTools%" NEQ "1" (
  if "%command%" == "1" if "%programs_system_program_3DBuilder%" == "installed" (
         %appxMgmt% remove 3DBuilder
  ) else %appxMgmt% add    3DBuilder

  if "%command%" == "2" if "%programs_system_program_3DViewer%" == "installed" (
  ...
  if "%command%" == "4" if "%programs_system_program_getHelp%" == "installed" (
         %appxMgmt% remove GetHelp
  ) else %appxMgmt% add    GetHelp

  if "%command%" == "5" if "%programs_system_program_mailCalendar%" == "installed" (
         %appxMgmt% remove WindowsCommunicationsApps
  ) else %appxMgmt% add    WindowsCommunicationsApps

  if "%command%" == "6" if "%programs_system_program_maps%" == "installed" (
         %appxMgmt% remove WindowsMaps
  ) else %appxMgmt% add    WindowsMaps

  if "%command%" == "7" if "%programs_system_program_messaging%" == "installed" (
         %appxMgmt% remove Messaging
  ) else %appxMgmt% add    Messaging

  if "%command%" == "8" if "%programs_system_program_mixedRealityPortal%" == "installed" (
         %appxMgmt% remove MixedReality.Portal
  ) else %appxMgmt% add    MixedReality.Portal

  if "%command%" == "9" if "%programs_system_program_mobilePlans%" == "installed" (
         %appxMgmt% remove OneConnect
  ) else %appxMgmt% add    OneConnect

  if "%command%" == "10" if "%programs_system_program_oneNote%" == "installed" (
         %appxMgmt% remove Office.OneNote
  ) else %appxMgmt% add    Office.OneNote

  if "%command%" == "11" if "%programs_system_program_people%" == "installed" (
         %appxMgmt% remove People
  ) else %appxMgmt% add    People

  if "%command%" == "12" if "%programs_system_program_print3D%" == "installed" (
         %appxMgmt% remove Print3D
  ) else %appxMgmt% add    Print3D

  if "%command%" == "13" if "%programs_system_program_solitare%" == "installed" (
         %appxMgmt% remove MicrosoftSolitaireCollection
  ) else %appxMgmt% add    MicrosoftSolitaireCollection

  if "%command%" == "14" if "%programs_system_program_tips%" == "installed" (
         %appxMgmt% remove GetStarted
  ) else %appxMgmt% add    GetStarted

  if "%command%" == "15" if "%programs_system_program_yourPhone%" == "installed" (
         %appxMgmt% remove YourPhone
  ) else %appxMgmt% add    YourPhone


  if "%command%" == "16" if "%programs_system_program_alarmsClock%" == "installed" (
         %appxMgmt% remove WindowsAlarms
  ) else %appxMgmt% add    WindowsAlarms

  if "%command%" == "17" if "%programs_system_program_camera%" == "installed" (
         %appxMgmt% remove WindowsCamera
  ) else %appxMgmt% add    WindowsCamera

  if "%command%" == "18" if "%programs_system_program_gameBar%" == "installed" (
  ...
  if "%command%" == "19" if "%programs_system_program_grooveMusic%" == "installed" (
         %appxMgmt% remove ZuneMusic
  ) else %appxMgmt% add    ZuneMusic

  if "%command%" == "20" if "%programs_system_program_moviesTV%" == "installed" (
         %appxMgmt% remove ZuneVideo
  ) else %appxMgmt% add    ZuneVideo

  if "%command%" == "21" if "%programs_system_program_myOffice%" == "installed" (
         %appxMgmt% remove MicrosoftOfficeHub
  ) else %appxMgmt% add    MicrosoftOfficeHub

  if "%command%" == "22" if "%programs_system_program_paint3D%" == "installed" (
         %appxMgmt% remove MSPaint
  ) else %appxMgmt% add    MSPaint

  if "%command%" == "23" if "%programs_system_program_photos%" == "installed" (
         %appxMgmt% remove Windows.Photos
  ) else %appxMgmt% add    Windows.Photos

  if "%command%" == "24" if "%programs_system_program_skype%" == "installed" (
         %appxMgmt% remove SkypeApp
  ) else %appxMgmt% add    SkypeApp

  if "%command%" == "25" if "%programs_system_program_snipSketch%" == "installed" (
         %appxMgmt% remove ScreenSketch
  ) else %appxMgmt% add    ScreenSketch

  if "%command%" == "26" if "%programs_system_program_stickyNotes%" == "installed" (
         %appxMgmt% remove MicrosoftStickyNotes
  ) else %appxMgmt% add    MicrosoftStickyNotes

  if "%command%" == "27" if "%programs_system_program_store%" == "installed" (
         %appxMgmt% remove WindowsStore
  ) else %appxMgmt% add    WindowsStore

  if "%command%" == "28" if "%programs_system_program_voiceRecorder%" == "installed" (
         %appxMgmt% remove WindowsSoundRecorder
  ) else %appxMgmt% add    WindowsSoundRecorder

  if "%command%" == "29" if "%programs_system_program_weather%" == "installed" (
         %appxMgmt% remove BingWeather
  ) else %appxMgmt% add    BingWeather

  if "%command%" == "30" if "%programs_system_program_xbox%" == "installed" (
...
set sBuilder_text=^(1^) %lang_programs_gpeditMSC03%
       if "%programs_gpeditMSC_gpeditFile%" == "exist"    ( %sBuilder_build% %lang_sBuilder_option_exist%
) else if "%programs_gpeditMSC_gpeditFile%" == "notExist" ( %sBuilder_build% %lang_sBuilder_option_notExist%
) else                                                      %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
set sBuilder_text=^(1^) %lang_services_windowsUpdate03%
       if "%services_windowsUpdate_updateDistributions%" == "locked"   ( %sBuilder_build% %lang_sBuilder_option_locked%
) else if "%services_windowsUpdate_updateDistributions%" == "unlocked" ( %sBuilder_build% %lang_sBuilder_option_unlocked%
) else                                                                   %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%

set sBuilder_text=^(2^) %lang_services_windowsUpdate04%
       if "%services_windowsUpdate_updateCenter%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%services_windowsUpdate_updateCenter%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                            %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
set sBuilder_text=^(1^) %lang_services_sppsvc03%
       if "%services_sppsvc_service%" == "enabled"  ( %sBuilder_build% %lang_sBuilder_option_enabled%
) else if "%services_sppsvc_service%" == "disabled" ( %sBuilder_build% %lang_sBuilder_option_disabled%
) else                                                %sBuilder_build% %lang_sBuilder_option_error%
echo.    %sBuilder_text%
...
echo.    ^(^!^) %lang_message_error_main_variables_disabledRegistryTools01%
echo.        %lang_message_error_main_variables_disabledRegistryTools02%
if "%1" == "main_menu" (
  echo.        %lang_message_error_main_variables_disabledRegistryTools03%
) else echo.        %lang_message_error_main_variables_disabledRegistryTools04%
echo.
exit /b
